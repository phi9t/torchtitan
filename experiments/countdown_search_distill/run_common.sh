...
countdown_setup_env() {
  ...
  export TORCHTITAN_COUNTDOWN_MANIFEST="${TORCHTITAN_COUNTDOWN_MANIFEST:-${TORCHTITAN_COUNTDOWN_ROOT}/results/manifests/current.jsonl}"
  mkdir -p \
    "${TORCHTITAN_COUNTDOWN_ROOT}/data" \
    "${TORCHTITAN_COUNTDOWN_ROOT}/results" \
    "${TORCHTITAN_COUNTDOWN_ROOT}/reports" \
    "${TORCHTITAN_COUNTDOWN_ROOT}/results/manifests" \
    "${HF_HOME}"
}
