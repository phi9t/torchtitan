...
# Wave F4 public hard-reasoning runner: AIME public-dataset vLLM smoke driven
...
then
  ...
  run_stage write-blocker-report-input report rootfs_cpu \
    ...
    --limitation "AIME hard-reasoning run stopped before model execution because vLLM GPU memory preflight failed." \
